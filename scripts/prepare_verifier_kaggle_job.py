"""Prepare the narrow, ignored Kaggle source for the verifier benchmark."""
...
def _source_files() -> dict[Path, str]:
    return {
        ...
        ROOT / "app" / "models" / "verifier.py": "app/models/verifier.py",
        ROOT / "scripts" / "run_verifier_benchmark.py": (
            "scripts/run_verifier_benchmark.py"
        ),
        ROOT / "evaluation" / "suites" / "v0_5" / "development_10.json": (
            "evaluation/suites/v0_5/development_10.json"
        ),
        ROOT / "evaluation" / "suites" / "v0_5" / "verifier_development.json": (
            "evaluation/suites/v0_5/verifier_development.json"
        ),
    }
...
def main() -> None:
    ...
    manifest = {
        "source": "scientific-research-agent v0.5 verifier benchmark package",
        "model": "Qwen/Qwen3-4B",
