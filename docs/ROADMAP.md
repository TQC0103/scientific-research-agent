...
2. Expand the reviewed suite from 10 to 25 cases with new papers and failure
...
3. Add production embedding-call instrumentation and structured abstention-
   reason classification only where the graph exposes reliable observations;
   do not estimate them from adapter behavior.
4. Independently validate or expand the 22-snapshot verifier development
